...
export function WishCard({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-body-lg font-medium text-ink">Видалити бажання?</p>
        <div className="flex gap-2">
          <Button variant="outline" onClick={onCancelDelete} tabIndex={confirmingDelete ? 0 : -1}>
            Скасувати
          </Button>
          <Button variant="destructive" onClick={onConfirmDelete} tabIndex={confirmingDelete ? 0 : -1}>
            Видалити
          </Button>
        </div>
      </div>
      ...
      >
        <div className="mb-2 flex items-start justify-between gap-2">
          ...
          <button
            ...
            aria-label={
              wish.isDone ? 'Зняти позначку «здійснено»' : 'Позначити здійсненим'
            }
